...
import '../styles/TigerFactory.css';
...
class TigerWoods extends Component {
    ...
    render() {
        ...
        return (
            <div className='tiger-factory-environment' id='tiger-factory'>
                ...
                <div className='dangers-container'>
                    <div className='smoke-container'> 
                        {this.state.danger1 && <img id='smoke-1' src='../img/game/smoke.png' alt='smoke' />}
                        {this.state.danger2 && <img id='smoke-2' src='../img/game/smoke.png' alt='smoke' />}
                        {this.state.danger3 && <img id='smoke-3' src='../img/game/smoke.png' alt='smoke' />}
                        {this.state.danger1 && this.state.danger2 && this.state.danger3 &&
                        <img id='factory' src='../img/game/factory.png' alt='factory' />}
                    </div> 
                    <div className='windmill-container'>
                        {!this.state.danger1 && !this.state.danger2 && !this.state.danger3 &&
                        <img id='windmills' src='../img/game/windmills.png' alt='windmills' />}
                    </div>
                </div>
