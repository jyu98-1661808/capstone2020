...
class TigerWoods extends Component {
    constructor(props) {
        super(props);
        this.state = {
            show: false,
        ...
        return (
            <div className='tiger-woods-environment' id='tiger-woods'>
                ...
                <div className='dangers-container'>
                    { this.props.type === 'tractor' && <div className='tractors-container'> 
                        {this.state.danger1 && <img id='tractor-3' src='../img/game/tractor-3.png' alt='tractor' />}
                        {this.state.danger2 && <img id='tractor-2' src='../img/game/tractor-2.png' alt='tractor' />}
                        {this.state.danger3 && <img id='tractor-1' src='../img/game/tractor-1.png' alt='tractor' />}
                    </div> }
                    { this.props.type === 'truck' && <div className='trucks-container'> 
                        {this.state.danger1 && <img id='truck-3' src='../img/game/truck-3.png' alt='truck' />}
                        {this.state.danger2 && <img id='truck-2' src='../img/game/truck-2.png' alt='truck' />}
                        {this.state.danger3 && <img id='truck-1' src='../img/game/truck-1.png' alt='truck' />}
                    </div> }
                    <div className='woods-container'>
                        {!this.state.danger1 && <img id='woods-3' src='../img/game/woods-3.png' alt='woods' />}
                        {!this.state.danger2 && <img id='woods-2' src='../img/game/woods-2.png' alt='woods' />}
                        {!this.state.danger3 && <img id='woods-1' src='../img/game/woods-1.png' alt='woods' />}
                    </div>
                </div>
                ...
                <div className='footer'>
                    ...
                    {this.state.waterUnlocked ? 
                        <img id='water-icon' src='./img/game/unlocked-sapling.png' alt='unlocked tree sapling icon' onClick={this.removeDanger} /> : 
                        <img id='water-icon' src='./img/game/locked-sapling.png' alt='locked tree sapling icon' />
                    }
                </div>
            </div>
        );
